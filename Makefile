...
all: hello $(PRU0_ROOT)/am335x-pru0-fw $(PRU1_ROOT)/am335x-pru1-fw

hello: hello.c
	gcc hello.c -o hello

$(PRU0_ROOT)/am335x-pru0-fw: $(CODE_ROOT)main0.c 
	mkdir -p $(PRU0_ROOT)
...
$(PRU1_ROOT)/am335x-pru1-fw: $(CODE_ROOT)main1.c
	mkdir -p $(PRU0_ROOT)
...
install: $(PRU0_ROOT)/am335x-pru0-fw $(PRU1_ROOT)/am335x-pru1-fw
...
clean:
	rm -f $(PRU0_ROOT)/am335x-pru0-fw
	rm -f $(PRU1_ROOT)/am335x-pru1-fw
	rm -f $(PRU0_ROOT)/*.object
	rm -f $(PRU1_ROOT)/*.object
	rm -f *.pp
	rm -f hello
